...
// ユーザーのブラウザから個別に再取得して表示する(SilverWeekAreaRetry・
// ObonAreaRetryと同じ設計、2026-09-20追加)。
export default function SportsdayAreaRetry({
  areaCode,
  prefName,
  nights,
}: {
  ...
  useEffect(() => {
    let cancelled = false;
    fetch(`/api/sportsday2026-area?area=${areaCode}`)
